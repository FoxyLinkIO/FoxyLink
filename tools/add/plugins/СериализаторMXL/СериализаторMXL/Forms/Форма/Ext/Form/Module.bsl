...
Процедура КоманднаяПанель1ЗагрузитьДанныеМакетаВБазу(Кнопка)
	Макет = Новый ТабличныйДокумент;
	Макет.Вывести(ЭлементыФормы.Макет);
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	Ответ = Вопрос("Вы действительно хотите закрыть обработку?", РежимДиалогаВопрос.ДаНет,,, "Подтвердите выход");

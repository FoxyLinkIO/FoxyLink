...
Процедура Тест_Проверить_ПустойМакетКомпоновкиДанных() Экспорт
	...
	ПараметрыМакета.Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
	...
	UpdateExpressПроцессорВывода.Вывести(ЗаписьJSON, ПараметрыВывода);
...
Процедура ПроверитьУтверждение(Наименование, ИмяКоманды, ТестовыеДанные)
	...
	ПараметрыМакета = UpdateExpressКомпоновкаДанных.ПараметрыМакетаКомпоновкиДанных();
	ПараметрыМакета.Схема = СхемаКомпоновкиДанных;
	ПараметрыМакета.Настройки = КомпоновщикНастроек.ПолучитьНастройки();

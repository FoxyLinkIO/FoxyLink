...
//	КэшРесурсов - Соответствие - Кэш в который будет содержать все ресурсы компоновки данных
//
...
// Функция предназначення для нормализации имен колонок, например, "Товары.Сумма"
// к виду: "ТоварыСумма"
//
// Параметры:
// 	ПутьКДанным - Строка - Колонка которую необходимо нормализировать
//

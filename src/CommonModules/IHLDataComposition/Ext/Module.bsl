...
//  OutputParameters - Structure - see function IHLDataComposition.NewOutputParameters.
...
Procedure Output(Mediator, StreamObject, OutputParameters, 
    ...
    DCTParameters = IHLCommonUseClientServer.CopyStructure(
...
//
// Parameters:
//  DCTParameters - Structure - see function IHLDataComposition.NewDataCompositionTemplateParameters.
//
// Returns:
...
Function GroupNames(Mediator, DataCompositionTemplate, 
    ...
    For Each ItemBody In DataCompositionTemplateBody Do
        ...
        If SaveResources = False Then
            SaveResources = Not IHLCommonUseClientServer.IsCorrectVariableName(
                ItemBody.Name);
        EndIf;
...
//                                Default value: Undefined.
//  ColumnsCache                - Structure                   - see function IHLDataComposition.NewColumnsCache.
//                                Default value: Undefined.
//  ResourcesCache              - Structure                   - see function IHLDataComposition.NewResourcesCache.
//                                Default value: Undefined.

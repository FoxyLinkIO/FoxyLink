...
Функция ФункцияПреобразования(Свойство, Значение, ДополнительныеПараметры,
	...
	ИначеЕсли ЭтоТипСправочникСсылка(ТипЗначения) Тогда
		Возврат XMLСтрока(Значение);
	ИначеЕсли ЭтоТипДокументСсылка(ТипЗначения) Тогда
		Возврат XMLСтрока(Значение);
	ИначеЕсли ЭтоТипПеречислениеСсылка(ТипЗначения) Тогда
		Возврат XMLСтрока(Значение);
	КонецЕсли;
...
Функция ЭтоТипСправочникСсылка(ТипЗначения)	
	Возврат Справочники.ТипВсеСсылки().СодержитТип(ТипЗначения);	
КонецФункции // ЭтоТипСправочникСсылка()

// Только для внутреннего использования
Функция ЭтоТипДокументСсылка(ТипЗначения)	
	Возврат Документы.ТипВсеСсылки().СодержитТип(ТипЗначения);	
КонецФункции // ЭтоТипДокументСсылка()

// Только для внутреннего использования
Функция ЭтоТипПеречислениеСсылка(ТипЗначения)
	Возврат Перечисления.ТипВсеСсылки().СодержитТип(ТипЗначения);	
